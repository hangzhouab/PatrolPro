...
public class ZhiShiDetailActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_zhishidetail);
	...
	private class LoadGongGaoDetailAysnTask extends AsyncTask<Object, Integer, Integer>{
		...
		protected Integer doInBackground(Object... params) {
			...
			String url = AppSetting.getRootURL() + "zhishidetail.php";
			int id = (Integer) params[0];
			Log.i("no", String.valueOf(id));
			String param = "?id="+id;		
